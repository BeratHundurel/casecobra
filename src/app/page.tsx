                  ...
                  <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                     ...
                     <div className="text-lg leading-8">
                        <p>
                           ...
                           <span className="p-0.5 bg-slate-800 text-white"> the image is super clear</span>, on the case ı had before, theimage started fading into yellow-ish color after a
